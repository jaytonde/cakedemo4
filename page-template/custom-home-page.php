          ...
          <div class="row">
            <?php if ( get_theme_mod('vw_bakery_call_no','') != "" ) {?>
              ...
              <div class="col-lg-10 col-md-10 col-9">
                <p><a href="tel:<?php echo esc_url( get_theme_mod('vw_bakery_call_no','') ); ?>"><?php echo esc_html(get_theme_mod('vw_bakery_call_no',''));?></a></p>            
              </div>
            <?php }?>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mid-contact">
          ...
          <div class="row">
            <?php if ( get_theme_mod('vw_bakery_email_address','') != "" ) {?>
              ...
              <div class="col-lg-10 col-md-10 col-9">
                <p><a href="mailto:<?php echo esc_html(get_theme_mod('vw_bakery_email_address',''));?>"><?php echo esc_html(get_theme_mod('vw_bakery_email_address',''));?></a></p>
              </div>
            <?php }?>
          </div>
        </div>
